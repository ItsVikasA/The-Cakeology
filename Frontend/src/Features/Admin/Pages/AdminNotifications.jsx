...
const AdminNotifications = () => {
    const { getNotificationsHandler, resolveNotificationHandler } = useAdmin();
    ...
    const handleResolve = async (n) => {
        ...
        try {
            await resolveNotificationHandler(n._id);
            await load();
        } catch (err) {
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 lg:px-10 py-10">
            <div className="mb-8">
                ...
                <p className="font-poppins text-[13.5px] font-light text-[#6B7280] mt-2">Refund requests raised when a paid order is cancelled.</p>
            </div>
